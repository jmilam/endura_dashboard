class Salesforces::SalesCallsController < ApplicationController
	def index
		...
		sales_force_starting_hash = {Q1: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q2: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q3: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q4: {bus_plan: 0, non_bus_plan: 0, total: 0}}, Total: {Q1: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q2: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q3: {bus_plan: 0, non_bus_plan: 0, total: 0}, Q4: {bus_plan: 0, non_bus_plan: 0, total: 0}}}
		...
		@sales_call_data.each do |value|
			...
			if @tsm_sales_call_details[value["dataCells"][3]["label"]].nil?
				@tsm_sales_call_details[value["dataCells"][3]["label"]] = {value["dataCells"][4]["label"] => sales_force_starting_hash
